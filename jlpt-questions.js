...
//  options  : 선택지 4개 배열 — options[0]이 꼭 정답일 필요는 없고,
//             answer 인덱스가 정답을 가리켜요
//  answer   : 정답 인덱스 (0~3)
//  note     : 정답 공개 후 보여줄 짧은 해설 (헷갈리는 이유 설명)
// ─────────────────────────────────────────────
...
const QUESTIONS = [
  ...
  },
  {
    ...
    options: ["学校", "学較", "学絞", "学郊"],
    answer: 0,
    note: "校(학교 교, 나무목)만 맞아요 — 較(비교할 교, 수레거)·絞(짤 교, 실사)·郊(들 교, 고을읍)는 다른 뜻이에요"
  },
  {
    id: "03",
    level: "N5",
  ...
  },
  {
    ...
    options: ["混", "困", "捆", "梱"],
    answer: 0,
    note: "混む(섞일 혼, 삼수변)가 맞아요 — 困(곤란할 곤)·捆(두드릴 곤, 손수변)·梱(문지방 곤, 나무목)은 다른 뜻이에요"
  },
  {
    id: "08",
    level: "N4",
    ...
    options: ["参", "惨", "傪", "蚕"],
    answer: 0,
    note: "参加(참여할 참)가 정답이에요 — 惨(참혹할 참, 마음심)·傪(사람인변)·蚕(누에 잠)은 加랑 안 어울려요"
  },
  ...
  },
  {
    ...
    options: ["理", "裏", "埋", "狸"],
    answer: 0,
    note: "道理(도리)의 理(다스릴 리, 구슬옥변)가 맞아요 — 裏(속 리, 옷의)·埋(묻을 매, 흙토)·狸(너구리 리, 개견)는 모양이 비슷해서 헷갈려요"
  },
  {
    id: "12",
    level: "N3",
    ...
    options: ["心", "芯", "沁", "忻"],
    answer: 0,
    note: "心を打つ(마음을 울리다)의 心(마음 심)이 맞아요 — 芯(심지 심, 풀초)·沁(스밀 심, 삼수변)·忻(기뻐할 흔)은 다른 글자예요"
  },
  ...
  // ───── N2 ─────
  {
    ...
    options: ["念", "捻", "稔", "恬"],
    answer: 0,
    note: "信念(신념)의 念(생각 념, 마음심)이 맞아요 — 捻(비틀 념, 손수변)·稔(여물 념, 벼화)·恬(편안할 념)은 소리는 같지만 다른 뜻이에요"
  },
  {
    id: "14",
    level: "N2",
    ...
    options: ["順", "循", "楯", "盾"],
    answer: 0,
    note: "順調(순조)의 順(순할 순)이 맞아요 — 循(돌 순, 두인변)·楯(방패 순, 나무목)·盾(방패 순)은 문맥에 안 맞아요"
  },
  {
    id: "15",
    level: "N2",
  ...
  },
  {
    ...
    options: ["実", "宝", "字", "宗"],
    answer: 0,
    note: "結実(결실)의 実(열매 실)이 맞아요 — 宝(보배 보)·字(글자 자)·宗(마루 종)은 갓머리(宀)까진 같지만 実이랑은 다른 글자라 結와 안 어울려요"
  },
  {
    id: "20",
    level: "N1",
